...
-- Create a least-privilege role for the rest of the workshop
...
-- Switch to the workshop role for all remaining checkpoints
USE ROLE GITTREND_MCP_ROLE;
USE DATABASE GITTREND_DB;
USE SCHEMA GITTREND_DB.PUBLIC;
USE WAREHOUSE WORKSHOP_WH;
...
-- Step 2: Create OAuth security integration (requires ACCOUNTADMIN)
